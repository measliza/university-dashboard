...
import InnovationSectionService from "./InnovationSectionService";
                ...
                <div>
                  ...
                  <div className="flex flex-row gap-4 px-4 py-2">
                    <div className="flex-1">
                      ...
                      <div className="mt-2">
                        <textarea className="h-35 block w-full rounded-md border-0 py-2 pl-5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-2xl sm:leading-6"></textarea>
                      </div>
                    </div>
